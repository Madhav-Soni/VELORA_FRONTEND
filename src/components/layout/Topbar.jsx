        ...
        <AnimatePresence>
          {showDropdown && input && (
            <motion.div
              ...
              className="absolute top-full left-0 w-[520px] mt-4 bg-[#0d0d0d] backdrop-blur-2xl rounded-[2rem] shadow-[0_32px_64px_rgba(0,0,0,0.95)] border border-white/10 z-[70] max-h-[70vh] overflow-y-auto scrollbar-hide"
            >
